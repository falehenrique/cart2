...
import br.com.exmart.indicadorRTDPJ.ui.RelatorioProtocoloOficialTd;
...
@SpringView(name = "protocolooficialtd")
@UIScope
@MenuCaption("Protocolo Oficial TD")
@MenuIcon(VaadinIcons.CHART)
public class RelatorioProtocoloOficialTdImpl extends RelatorioProtocoloOficialTd implements View {
    ...
    public RelatorioProtocoloOficialTdImpl() {
...
// Image as a file resource
            FileResource resource = new FileResource(new File(basepath +
                    "/static/relatorios/Protocolo_Oficial_TD.jrxml"));
...
//            File resource = new File("classpath:");
            ...
            resourcesReport = new StreamResource(source, "Protocolo_Oficial_TD" + System.currentTimeMillis() + ".PDF");
