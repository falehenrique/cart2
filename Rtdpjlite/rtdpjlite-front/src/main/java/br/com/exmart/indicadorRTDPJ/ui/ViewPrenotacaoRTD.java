...
public class ViewPrenotacaoRTD extends VerticalLayout {
    ...
    protected CssLayout conteudo;
    protected HorizontalLayout panelAndamentoRegistro;

    public ViewPrenotacaoRTD() {
		Design.read(this);
	}
}
