...
@SpringView(name = "protocolooficialexamepj")
@UIScope
@MenuCaption("Livro de Exame e Cálculo PJ")
@MenuIcon(VaadinIcons.CHART)
public class RelatorioProtocoloOficialExamePjImpl extends RelatorioProtocoloOficialExamePj implements View {
    @Autowired
    ...
    public RelatorioProtocoloOficialExamePjImpl() {
...
// Image as a file resource
            FileResource resource = new FileResource(new File(basepath +
                    "/static/relatorios/Protocolo_Oficial_Exame_PJ.jrxml"));
...
//            File resource = new File("classpath:");
            ...
            resourcesReport = new StreamResource(source, "Protocolo_Oficial_Exame_PJ" + System.currentTimeMillis() + ".PDF");
