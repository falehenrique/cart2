...
import br.com.exmart.indicadorRTDPJ.ui.RelatorioRecolhimentoExtraJudicial;
...
@SpringView(name = "recolhimentoextrajudicial")
@UIScope
@MenuCaption("Rec. Extrajudicial")
@MenuIcon(VaadinIcons.CHART)
public class RelatorioRecolhimentoExtraJudicialImpl extends RelatorioRecolhimentoExtraJudicial implements View {
    @Autowired
    ...
    public RelatorioRecolhimentoExtraJudicialImpl() {
...
// Image as a file resource
            FileResource resource = new FileResource(new File(basepath +
                    "/static/relatorios/Recolhimento_PortalExtrajudicial.jrxml"));
...
//            File resource = new File("classpath:");
            ...
            resourcesReport = new StreamResource(source, "Recolhimento_PortalExtrajudicial" + System.currentTimeMillis() + ".PDF");
