...
import br.com.exmart.indicadorRTDPJ.ui.RelatorioProtocoloOficialExamePj;
import br.com.exmart.indicadorRTDPJ.ui.RelatorioProtocoloOficialExameTd;
...
@SpringView(name = "protocolooficialexametd")
@UIScope
@MenuCaption("Livro de Exame e Cálculo TD")
@MenuIcon(VaadinIcons.CHART)
public class RelatorioProtocoloOficialExameTdImpl  extends RelatorioProtocoloOficialExameTd implements View {
    @Autowired
    ...
    public RelatorioProtocoloOficialExameTdImpl() {
...
// Image as a file resource
            FileResource resource = new FileResource(new File(basepath +
                    "/static/relatorios/Protocolo_Oficial_Exame_TD.jrxml"));
...
//            File resource = new File("classpath:");
            ...
            resourcesReport = new StreamResource(source, "Protocolo_Oficial_Exame_TD" + System.currentTimeMillis() + ".PDF");
