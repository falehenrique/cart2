      ...
      <section class="sheet padding-10mm">
         ...
         <article>
            ...
            <table width="100%" class="cabecalho">
               ...
               <tr>
                  <td style="font-size: large;">Protocolo nº <strong>${protocolo.numero?string("00000000")}</strong> - ${tipoProtocolo}</td>
               </tr>
            </table>
            <p></p>
            <table style="width: 100%; float: left;" cellspacing="0">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="linhaVertical"></td>
                     <td class="linhapadding">Previs&atilde;o Entrega: <strong>${protocolo.dataPrevista.format('dd/MM/yyyy')}</strong></td>
                  </tr>
                  <tr>
                     <td>Responsável: <#if protocolo.responsavel??><strong>${protocolo.responsavel}</strong></#if></strong></td>
                     <td class="linhaVertical"></td>
                     <td class="linhapadding">
                        <#if protocolo.tipo?starts_with("PRENOTACAO") == true>
                  ...
                  <tr>
                     ...
                     <td class="linhapadding" rowspan="3">
                        <table class="custas <#if protocolo.tipo?starts_with("CERTIDAO") == false> invisivel</#if>" style="width: 95%; border-color: black; border: 1px solid black;">
                           <tbody>
                  ...
                  <tr>
                     <td style="width: 50%; font-size: smaller;">
                        <br />
                        Obs: <strong><#if protocolo.observacoes?? >${protocolo.observacoes}</#if><br /><br /></strong>
                            <table class="custas <#if protocolo.tipo?starts_with("PRENOTACAO") == false> invisivel <#else> nao</#if>" style="font-size: smaller; width: 95%; border-color: black; border: 1px solid black;" >
                               <tbody>
                                  <tr>
                                     <td class="cellpadding">
                                        O Apresentante dever&aacute; comparecer a esta Serventia, a partir de 10 dias , a contar da data de apresenta&ccedil;&atilde;o deste, a fim &nbsp;de inteirar sobre a validade e legalidade do titulo. Se n&atilde;o houver exig&ecirc;ncia a ser satisfeita, o interessado poder&aacute; retirar o titulo a partir de 30 dias a contar da data de apresenta&ccedil;&atilde;o, munido deste recibo
                                     </td>
                                  </tr>
                               </tbody>
                            </table>
                  ...
                  <tr>
                     <td style="text-align: center; font-size: small;">&nbsp;A PARTE INTERESSADA DEVER&Aacute; APRESENTAR<br />ESTE DOCUMENTO PARA RETIRADA
                     <#if protocolo.tipo?starts_with("CERTIDAO") == true??> DA CERTIDÃO <#else> DO T&Iacute;TULO </#if>
                     </td>
                     <td class="linhaVertical"></td>
                     <td class="linhapadding"> Depósito Prévio R$: <strong>${vlDeposito?string("0.00")}</strong>
                     </td>
                  </tr>
                  <tr>
                     <td>&nbsp;</td>
                  ...
                  <tr>
                     <td style="text-align: center;">____________________________________<br />Assinatura do Apresentante</td>
                     <td class="linhaVertical"></td>
