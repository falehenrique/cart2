...
public class JsonObjetoProtocoloUserTypeSingle implements UserType {
    ...
    public Object deepCopy(Object originalValue) throws HibernateException {
        ...
        if (!(originalValue instanceof ObjetoProtocoloVO)) {
            return null;
        }
...
//        return resultMap;
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        if (o.getValue() != null) {
            return gson.fromJson(o.getValue(), new TypeToken<ObjetoProtocoloVO>(){}.getType());
        }

        return new ObjetoProtocoloVO();
    }
    ...
    @Override
    public Class<ObjetoProtocoloVO> returnedClass() {
        return ObjetoProtocoloVO.class;
    }
