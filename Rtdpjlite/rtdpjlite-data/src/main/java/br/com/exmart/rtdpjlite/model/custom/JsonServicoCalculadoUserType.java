...
public class JsonServicoCalculadoUserType  implements UserType {

    private final Gson gson = new GsonBuilder().serializeNulls().create();
    private ServicoCalculado objetos;

    public void setObjetos(ServicoCalculado objetos) {
        this.objetos = objetos;
    }

    public ServicoCalculado getObjetos() {
        return objetos;
    }
...
//        return resultMap;
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        if (o.getValue() != null) {
            return gson.fromJson(o.getValue(), new TypeToken<List<ServicoCalculado>>(){}.getType());
        }

        return new ArrayList<ServicoCalculado>();
    }
