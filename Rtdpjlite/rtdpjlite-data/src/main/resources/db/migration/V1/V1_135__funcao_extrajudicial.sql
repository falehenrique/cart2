CREATE TYPE rel_portalextrajudicial_type AS
   (protocolo integer,
    data_registro date,
...
ALTER TYPE rel_portalextrajudicial_type
  OWNER TO exmart;
...
CREATE OR REPLACE FUNCTION rel_portalextrajudicial(
    date,
    date)
  RETURNS SETOF rel_portalextrajudicial_type AS
$BODY$
declare
_dtI alias for $1;
_dtF alias for $2;
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION rel_portalextrajudicial(date, date)
  OWNER TO exmart;
