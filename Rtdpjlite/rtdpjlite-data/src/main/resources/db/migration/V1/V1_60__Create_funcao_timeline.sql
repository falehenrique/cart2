CREATE TYPE card_timeline AS (
   id_protocolo bigint,
    registro VARCHAR(255),
    natureza VARCHAR(255),
    escrevente VARCHAR(255),
    dia TIMESTAMP,
...
$BODY$
	...
	BEGIN
        ...
        select INTO _r p.id, p.numero_registro, n.nome, 'escrevente', p.dt_registro, p.situacao_atual_registro, registro_referencia, p.numero
        FROM protocolo p
